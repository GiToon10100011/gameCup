...
- 현재 활성 사이클: **Cycle 1 — 2026-05-24 ~ 2026-06-21 (4주, KST 자정 경계)**
- 미래 사이클: **Cycle 2 — 2026-06-21 ~ 2026-07-19 (4주)** 1개만 존재
...
- [ ] 첫 번째 사이클의 `startsAt`이 `2026-05-23T15:00:00.000Z` (= KST 2026-05-24 00:00, UTC+9 오프셋)인지 확인
- [ ] 첫 번째 사이클의 `endsAt`이 `2026-06-20T15:00:00.000Z` (= KST 2026-06-21 00:00)인지 확인
- [ ] `endsAt - startsAt`이 **28일(4주 = 2,419,200초)**인지 확인
- [ ] 2026-05-24 KST 이후 검증 시점에는 `isCurrent: true`인 사이클이 **정확히 1개** 존재. 그 이전(5/24 자정 KST 이전) 시점이면 첫 사이클은 `isCurrent: false`로 미래 사이클 취급
- [ ] 미래 사이클(`startsAt`이 현재 이후인 사이클)이 **1개**만 존재하는지 확인
...
| `2026-06-20T15:00:00.000Z` | 2026-06-21 00:00 KST (Cycle 1 종료 = Cycle 2 시작) |
| `2026-07-18T15:00:00.000Z` | 2026-07-19 00:00 KST (Cycle 2 종료) |
